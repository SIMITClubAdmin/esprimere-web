        ...
        <footer className="bg-[#4A3B2F] text-[#D4C4A8] py-8 md:py-12">
            <div className="container mx-auto px-6 md:px-8">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <a
                                    ...
                                    className="text-[#D4C4A8] hover:text-white transition-colors duration-300 font-crimson text-lg"
                                >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[#D4C4A8] font-crimson text-lg">
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <div className="flex gap-4 md:justify-end">
                            ...
                            <a
                                ...
                                className="w-15 h-15 bg-[#5A4A3C] hover:bg-[#6B5B4D] rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                                aria-label="Instagram"
                            >
                                <svg className="w-7 h-7 text-[#D4C4A8]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-center md:text-center">
                    <p className="text-[#A09080] font-crimson text-lg">
                        Website made by{' '}
                        <a
                            href="https://simitclub.github.io/"
