...
export default function CurrentActivities() {
  return (
    <section
      className="pt-20 relative bg-cover bg-center bg-no-repeat"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-64">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div className="text-white">
            <h3 className="font-saint-pauline text-5xl md:text-6xl mb-4">
              Vocal Lessons
            </h3>
            <p className="font-crimson text-2xl md:text-3xl font-semibold mb-4 text-amber-200">
              Tuesday & Friday
            </p>
            <p className="font-crimson text-xl md:text-2xl leading-relaxed">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            {/* Who Can Join */}
            <div className="text-white">
              <h3 className="font-saint-pauline text-5xl md:text-6xl mb-6">
                Who Can Join
              </h3>
              <p className="font-crimson text-xl md:text-2xl leading-relaxed">
            ...
            <div className="text-white">
              ...
              <p className="font-crimson text-xl md:text-2xl leading-relaxed">
                Our membership intakes happen a few times a year. Follow{' '}
                <a
                  href="https://www.instagram.com/esprimeresings/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline text-amber-200 hover:text-white transition-colors duration-300"
                >
                  @esprimeresings
                </a>{' '}
                for announcements and dates!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-8">
            ...
            <div className="flex-grow text-white">
              ...
              <div className="space-y-10">
                {/* Step 1 */}
                <div>
                  <h4 className="font-saint-pauline text-4xl md:text-5xl mb-4">
